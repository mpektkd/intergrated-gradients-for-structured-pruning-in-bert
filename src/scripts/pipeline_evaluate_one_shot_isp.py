        ...
        if os.path.isdir(task_path):
            ...
            for sample in sorted(os.listdir(task_path)):
                ...
                if os.path.isdir(sample_path):
                    ...
                    files = [f for f in os.listdir(sample_path) if fnmatch.fnmatch(f, 'head_importance_0.npy')]
...
def pipe():
    ...
    for task in npy_data:
        ...
        # model_name_or_path = tuned_model + task + f'/seed_{seed}'
        model, _, t_config, _, _, _ = load_configuration(model_name_or_path, task, max_seq_length)

        tokenizer = t_config['tokenizer']
        ...
        for importance_key, importance_value in npy_data[task][f'balanced_samples_{_samples}'].items():
            ...
            while True:            
                ...
                output_dir = os.path.join(base_path2, task, f'balanced_samples_{_samples}', f"head_mask_{i}")
